  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline: "border border-border bg-background hover:bg-accent hover:text-accent-foreground shadow-card hover:shadow-hover",
        ...
        professional: "bg-gradient-primary text-primary-foreground hover:opacity-90 shadow-hover font-semibold",
        accent: "bg-accent text-accent-foreground hover:bg-accent-light shadow-card hover:shadow-hover",
        ...
        premium: "bg-gradient-accent text-accent-foreground hover:opacity-90 shadow-hover font-semibold border border-accent/20",
      },
      size: {
